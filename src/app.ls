...
(macro -> (rest...)
	(chain ~rest...))
(macro set (args...)
	(console.log "set is not allowed"))
(macro vector (rest...) 
...
(console.log (hashMap "a" 1 "b" 2))
(console.log (vector "a" 1 "b" 2))
(console.log (head (vector "a" 1 "b" 2)))
(console.log (tail (vector "a" 1 "b" 2)))
(console.log (get (hashMap "a" 1 "b" 2) "b"))
