...
console.log((require("mori")).hashMap("a",1,"b",2));
console.log((require("mori")).vector("a",1,"b",2));
console.log((require("mori")).first((require("mori")).vector("a",1,"b",2)));
console.log((require("mori")).rest((require("mori")).vector("a",1,"b",2)));
console.log((require("mori")).get((require("mori")).hashMap("a",1,"b",2),"b"));
